...
Use this skill to help an AI one-shot implement embedded or backend-direct Trade It partner integrations, including:
...
- direct account, holdings, create, execute, cancel, and status calls from partner servers
